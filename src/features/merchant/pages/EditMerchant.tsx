...
const EditMerchant = () => {
  ...
  const handleJfsFormChange = (
    ...
    console.log(`EditMerchant - handleJfsFormChange - isIdentical: [${isIdentical}]`);
    console.log(`EditMerchant - handleJfsFormChange - jfsDataInitStr: `, jfsDataInitStr);
    console.log(`EditMerchant - handleJfsFormChange - retDataStr: `, retDataStr);
    if (isIdentical) {
