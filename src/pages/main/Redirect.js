...
const Redirect = () => {
  ...
  useEffect(() => {
    if (code) {
      console.log('Redirect - useEffect - searchParams - code: [' + code + ']');
      ...
      const tokenFetch = async () => {
        ...
        if (response.ok) {
          ...
          console.log('Redirect - useEffect - tokenUrl: [' + tokenUrl 
          + '], sessionStorage.getItem(access_token): [' + sessionStorage.getItem('access_token') 
          + ']');
      ...
      console.log('Redirect - useEffect - authorizeUrl: [' + authorizeUrl + ']');
