...
export const TIMEZONE_DEFAULT: string = process.env.REACT_APP_TIMEZONE as string;

export const formatDate = (date?: Date, pattern: string = DATE_FORMAT_DEFAULT) => {
  // return date == null ? date : format(date, pattern);
  return date == null ? date : formatInTimeZone(date, TIMEZONE_DEFAULT, pattern);
};
export const formatDatetime = (date?: Date, pattern: string = DATE_TIME_FORMAT_DEFAULT) => {
  // return date == null ? date : format(date, pattern);
  return date == null ? date : formatInTimeZone(date, TIMEZONE_DEFAULT, pattern);
};
export const parseDateToUtc = (obj: Date | string | number) => {
